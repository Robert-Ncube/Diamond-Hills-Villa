      ...
      <div className="flex flex-col items-center justify-center md:flex-row p-4 h-auto">
        ...
        <div className="text-start w-full md:w-1/2 px-4">
          ...
          <h1 className="text-2xl py-2 md:text-3xl lg:text-4xl">
            Satisfying Pool Villa with Private Pool
          </h1>
          <p className="text-md my-2 py-2">
            A spacious, well-equipped villa with a private pool, spacious living
            room, dining area, and two bedrooms. It has a fully equipped
            kitchen, bathroom, and shower. The pool offers an excellent view of
            the surrounding
          </p>
